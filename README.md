...
`agent-sphere 0.3.0-38` is the headless core of the native AGPC standard/full
...
contextd      Native task context sandbox (required)
...
signed `agent-computer-v0.3.0-45` aggregate; publishing this Core source release
...
| --- | --- |
| `agpc.sh` | Core `0.3.0-38`, Ultra `0.1.0-1`, AGPC Manager `3.3.0-1`, contextd `0.1.0-27`, uchat `3.2.0-6`, uchatd `0.6.0-1` |
...
The frontend package and command are `agpc-manager 3.3.0-1`, paired with
`medge 3.3.0-1`; the predecessor is `sphere-manager`. The existing `sphere`
...
The migration guard binds CX-Mesh 1.2.0-1 and AGPC Manager 3.3.0-1 to their
