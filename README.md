...
`agent-sphere 0.3.0-20` is the headless core of the native AGPC standard/full
...
| --- | --- |
| `agpc.sh` | Core `0.3.0-20`, Ultra `0.1.0-1`, AGPC Manager `3.3.0-1`, contextd `0.1.0-16`, uchatd `0.5.0-1` |
