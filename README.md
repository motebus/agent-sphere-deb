...
`agent-sphere 0.3.0-30` is the headless core of the native AGPC standard/full
...
| --- | --- |
| `agpc.sh` | Core `0.3.0-30`, Ultra `0.1.0-1`, AGPC Manager `3.3.0-1`, contextd `0.1.0-27`, uchatd `0.5.0-1` |
