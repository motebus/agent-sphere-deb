Agent Sphere 0.3.0-21 carries native standard and full installer profiles with
contextd 0.1.0-18's fixed native Debian postinst allocation and outer user namespace sandbox.
