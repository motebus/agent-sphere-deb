Agent Sphere 0.3.0-29 carries native standard and full installer profiles with
contextd 0.1.0-26's fixed native Debian postinst allocation and outer user namespace sandbox.
