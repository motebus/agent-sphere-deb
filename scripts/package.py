...
NAMES = {'mlink', 'mote-proxy', 'model-router', 'cx-mesh', 'mote-mcpd', 'cx-loop', 'model-llm', 'moted', 'mote-transportd', 'mote-secd', 'agos', 'sphered', 'contextd', 'uchat', 'uchatd'}
...
def check_control(meta):
    ...
    if meta["Package"] != "agent-sphere" or meta["Architecture"] != "all" or meta["Version"] != "0.3.0-43":
